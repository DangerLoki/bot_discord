"""Remoção, promoção e limpeza da playlist."""
import discord

from src.logger import get_logger
from src.services.playlist_resolver import resolver_entrada_por_titulo
...
class PlaylistManage:
    """Remoção, promoção e limpeza de vídeos na fila."""
    ...
    async def promover_video(self, ctx, entrada: str | None = None, bot=None) -> None:
        ...
        async def _resolver_nao_numerico(entrada_str):
            ...
            if bot is None:
                ...
                return None, None, None
            i, v, msg = await resolver_entrada_por_titulo(ctx, bot, playlist, entrada_str)
